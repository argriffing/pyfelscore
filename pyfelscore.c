/* Generated by Cython 0.16 on Sat Feb  2 23:16:12 2013 */
...
static char __pyx_k_49[] = "/home/argriffi/git-repos/pyfelscore/pyfelscore.pyx";
static char __pyx_k_54[] = "align_rooted_star_tree";
...
static PyObject *__pyx_pw_10pyfelscore_1align_fels(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__OV);
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("align_fels", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__patterns);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_fels", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__pattern_weights);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_fels", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__multi_P);
        if (likely(values[4])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_fels", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__root_prior);
        if (likely(values[5])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_fels", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "align_fels") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __Pyx_RaiseArgtupleInvalid("align_fels", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyfelscore.align_fels", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_OV), __pyx_ptype_5numpy_ndarray, 1, "OV", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_DE), __pyx_ptype_5numpy_ndarray, 1, "DE", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_patterns), __pyx_ptype_5numpy_ndarray, 1, "patterns", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pattern_weights), __pyx_ptype_5numpy_ndarray, 1, "pattern_weights", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_multi_P), __pyx_ptype_5numpy_ndarray, 1, "multi_P", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_root_prior), __pyx_ptype_5numpy_ndarray, 1, "root_prior", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_10pyfelscore_align_fels(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_OV, PyArrayObject *__pyx_v_DE, PyArrayObject *__pyx_v_patterns, PyArrayObject *__pyx_v_pattern_weights, PyArrayObject *__pyx_v_multi_P, PyArrayObject *__pyx_v_root_prior) {
  ...
  __pyx_pybuffernd_root_prior.rcbuffer = &__pyx_pybuffer_root_prior;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_OV.rcbuffer->pybuffer, (PyObject*)__pyx_v_OV, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_DE.rcbuffer->pybuffer, (PyObject*)__pyx_v_DE, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_patterns.rcbuffer->pybuffer, (PyObject*)__pyx_v_patterns, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_pattern_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_pattern_weights, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_multi_P.rcbuffer->pybuffer, (PyObject*)__pyx_v_multi_P, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_root_prior.rcbuffer->pybuffer, (PyObject*)__pyx_v_root_prior, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_1 = PyInt_FromLong(__pyx_v_nvertices); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromLong(__pyx_v_nstates); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     # sum over all of the patterns
 */
  if (PyDict_SetItem(__pyx_t_4, ((PyObject *)__pyx_n_s__dtype), ((PyObject *)((PyObject*)(&PyFloat_Type)))) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (unlikely(!__pyx_t_12.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_10pyfelscore_align_fels_experimental(__pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
...
static PyObject *__pyx_pw_10pyfelscore_3site_fels(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("site_fels", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__pattern);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("site_fels", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__multi_P);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("site_fels", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__root_prior);
        if (likely(values[4])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("site_fels", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "site_fels") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("site_fels", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyfelscore.site_fels", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_OV), __pyx_ptype_5numpy_ndarray, 1, "OV", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_DE), __pyx_ptype_5numpy_ndarray, 1, "DE", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pattern), __pyx_ptype_5numpy_ndarray, 1, "pattern", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_multi_P), __pyx_ptype_5numpy_ndarray, 1, "multi_P", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_root_prior), __pyx_ptype_5numpy_ndarray, 1, "root_prior", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_10pyfelscore_2site_fels(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_OV, PyArrayObject *__pyx_v_DE, PyArrayObject *__pyx_v_pattern, PyArrayObject *__pyx_v_multi_P, PyArrayObject *__pyx_v_root_prior) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_OV.rcbuffer->pybuffer, (PyObject*)__pyx_v_OV, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_OV.diminfo[0].strides = __pyx_pybuffernd_OV.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_OV.diminfo[0].shape = __pyx_pybuffernd_OV.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_DE.rcbuffer->pybuffer, (PyObject*)__pyx_v_DE, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_DE.diminfo[0].strides = __pyx_pybuffernd_DE.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_DE.diminfo[0].shape = __pyx_pybuffernd_DE.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_DE.diminfo[1].strides = __pyx_pybuffernd_DE.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_DE.diminfo[1].shape = __pyx_pybuffernd_DE.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_pattern.rcbuffer->pybuffer, (PyObject*)__pyx_v_pattern, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_multi_P.rcbuffer->pybuffer, (PyObject*)__pyx_v_multi_P, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_multi_P.diminfo[0].strides = __pyx_pybuffernd_multi_P.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_multi_P.diminfo[0].shape = __pyx_pybuffernd_multi_P.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_multi_P.diminfo[1].strides = __pyx_pybuffernd_multi_P.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_multi_P.diminfo[1].shape = __pyx_pybuffernd_multi_P.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_multi_P.diminfo[2].strides = __pyx_pybuffernd_multi_P.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_multi_P.diminfo[2].shape = __pyx_pybuffernd_multi_P.rcbuffer->pybuffer.shape[2];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_root_prior.rcbuffer->pybuffer, (PyObject*)__pyx_v_root_prior, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_root_prior.diminfo[0].strides = __pyx_pybuffernd_root_prior.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_root_prior.diminfo[0].shape = __pyx_pybuffernd_root_prior.rcbuffer->pybuffer.shape[0];
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__empty); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  __pyx_t_1 = PyInt_FromLong(__pyx_v_nvertices); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromLong(__pyx_v_nstates); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 *     # return the log likelihood
 */
  if (PyDict_SetItem(__pyx_t_4, ((PyObject *)__pyx_n_s__dtype), ((PyObject *)((PyObject*)(&PyFloat_Type)))) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
 ...
 */
  ...
  if (unlikely(!__pyx_t_11.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_10pyfelscore_site_fels_experimental(__pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10, __pyx_t_11)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
...
static PyObject *__pyx_pw_10pyfelscore_5align_rooted_star_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__patterns);
        if (likely(values[0])) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__pattern_weights);
        if (likely(values[1])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_rooted_star_tree", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__multi_P);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_rooted_star_tree", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__root_prior);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("align_rooted_star_tree", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "align_rooted_star_tree") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_patterns = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_int_t(values[0]); if (unlikely(!__pyx_v_patterns.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 224; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_pattern_weights = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[1]); if (unlikely(!__pyx_v_pattern_weights.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 225; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_multi_P = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_5numpy_float64_t(values[2]); if (unlikely(!__pyx_v_multi_P.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 226; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_root_prior = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[3]); if (unlikely(!__pyx_v_root_prior.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 227; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("align_rooted_star_tree", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_13 = PyFloat_FromDouble(__pyx_v_ll_accum); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 262; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         np.ndarray[np.int_t, ndim=2] DE,
 */
  __pyx_k_tuple_47 = PyTuple_New(12); if (unlikely(!__pyx_k_tuple_47)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_47);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__OV));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 0, ((PyObject *)__pyx_n_s__OV));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__OV));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__DE));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 1, ((PyObject *)__pyx_n_s__DE));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__DE));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__patterns));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 2, ((PyObject *)__pyx_n_s__patterns));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__patterns));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__pattern_weights));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 3, ((PyObject *)__pyx_n_s__pattern_weights));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__pattern_weights));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__multi_P));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 4, ((PyObject *)__pyx_n_s__multi_P));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__multi_P));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__root_prior));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 5, ((PyObject *)__pyx_n_s__root_prior));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__root_prior));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__nvertices));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 6, ((PyObject *)__pyx_n_s__nvertices));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__nvertices));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__nstates));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 7, ((PyObject *)__pyx_n_s__nstates));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__nstates));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__npatterns));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 8, ((PyObject *)__pyx_n_s__npatterns));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__npatterns));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__ll_pattern));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 9, ((PyObject *)__pyx_n_s__ll_pattern));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__ll_pattern));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__ll_total));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 10, ((PyObject *)__pyx_n_s__ll_total));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__ll_total));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__likelihoods));
  PyTuple_SET_ITEM(__pyx_k_tuple_47, 11, ((PyObject *)__pyx_n_s__likelihoods));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__likelihoods));
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_47));
  __pyx_k_codeobj_48 = (PyObject*)__Pyx_PyCode_New(6, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_47, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_49, __pyx_n_s__align_fels, 47, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_48)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         np.ndarray[np.int_t, ndim=2] DE,
 */
  __pyx_k_tuple_50 = PyTuple_New(8); if (unlikely(!__pyx_k_tuple_50)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_50);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__OV));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 0, ((PyObject *)__pyx_n_s__OV));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__OV));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__DE));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 1, ((PyObject *)__pyx_n_s__DE));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__DE));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__pattern));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 2, ((PyObject *)__pyx_n_s__pattern));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__pattern));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__multi_P));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 3, ((PyObject *)__pyx_n_s__multi_P));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__multi_P));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__root_prior));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 4, ((PyObject *)__pyx_n_s__root_prior));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__root_prior));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__nvertices));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 5, ((PyObject *)__pyx_n_s__nvertices));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__nvertices));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__nstates));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 6, ((PyObject *)__pyx_n_s__nstates));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__nstates));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__likelihoods));
  PyTuple_SET_ITEM(__pyx_k_tuple_50, 7, ((PyObject *)__pyx_n_s__likelihoods));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__likelihoods));
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_50));
  __pyx_k_codeobj_51 = (PyObject*)__Pyx_PyCode_New(5, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_50, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_49, __pyx_n_s__site_fels, 82, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_51)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         np.float64_t [:] pattern_weights,
 */
  __pyx_k_tuple_52 = PyTuple_New(14); if (unlikely(!__pyx_k_tuple_52)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_52);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__patterns));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 0, ((PyObject *)__pyx_n_s__patterns));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__patterns));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__pattern_weights));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 1, ((PyObject *)__pyx_n_s__pattern_weights));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__pattern_weights));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__multi_P));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 2, ((PyObject *)__pyx_n_s__multi_P));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__multi_P));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__root_prior));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 3, ((PyObject *)__pyx_n_s__root_prior));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__root_prior));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__nleaves));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 4, ((PyObject *)__pyx_n_s__nleaves));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__nleaves));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__npatterns));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 5, ((PyObject *)__pyx_n_s__npatterns));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__npatterns));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__nstates));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 6, ((PyObject *)__pyx_n_s__nstates));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__nstates));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__ll_accum));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 7, ((PyObject *)__pyx_n_s__ll_accum));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__ll_accum));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__plike));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 8, ((PyObject *)__pyx_n_s__plike));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__plike));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__p));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 9, ((PyObject *)__pyx_n_s__p));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__p));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__pattern_index));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 10, ((PyObject *)__pyx_n_s__pattern_index));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__pattern_index));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__leaf_index));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 11, ((PyObject *)__pyx_n_s__leaf_index));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__leaf_index));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__root_state));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 12, ((PyObject *)__pyx_n_s__root_state));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__root_state));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__leaf_state));
  PyTuple_SET_ITEM(__pyx_k_tuple_52, 13, ((PyObject *)__pyx_n_s__leaf_state));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__leaf_state));
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_52));
  __pyx_k_codeobj_53 = (PyObject*)__Pyx_PyCode_New(4, 0, 14, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_52, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_49, __pyx_n_s_54, 223, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_53)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("pyfelscore"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_46), 0, PYTHON_API_VERSION);
  #else
 ...
 *         np.ndarray[np.int_t, ndim=2] DE,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10pyfelscore_1align_fels, NULL, __pyx_n_s__pyfelscore); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__align_fels, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         np.ndarray[np.int_t, ndim=2] DE,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10pyfelscore_3site_fels, NULL, __pyx_n_s__pyfelscore); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__site_fels, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         np.float64_t [:] pattern_weights,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10pyfelscore_5align_rooted_star_tree, NULL, __pyx_n_s__pyfelscore); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_54, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
  __pyx_t_1 = __pyx_capsule_create(((void *)(&__pyx_memoryview_getbuffer)), __pyx_k_55); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 957; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
